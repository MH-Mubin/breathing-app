            ...
            <div className="p-6">
              ...
              <div className="space-y-3">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={handleLogin}
                  className="w-full bg-gradient-to-r from-orange-400 to-orange-500 text-white py-3 rounded-full font-semibold hover:from-orange-500 hover:to-orange-600 transition-all shadow-md"
                >
                  Log In to Continue
                </motion.button>
                ...
                <motion.button
                  ...
                  className="w-full bg-white border-2 border-orange-400 text-orange-500 py-3 rounded-full font-semibold hover:bg-orange-50 transition-all"
                >
                  Create New Account
                </motion.button>

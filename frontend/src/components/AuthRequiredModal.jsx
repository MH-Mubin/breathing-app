...
export default function AuthRequiredModal({ isOpen, onClose }) {
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center bg-black bg-opacity-50 px-4 py-4 sm:py-6 overflow-y-auto">
          <motion.div
            initial={{ opacity: 0, scale: 0.9, y: 20 }}
            animate={{ opacity: 1, scale: 1, y: 0 }}
            exit={{ opacity: 0, scale: 0.9, y: 20 }}
            transition={{ duration: 0.2 }}
            className="bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[calc(100vh-2rem)] sm:max-h-[calc(100vh-3rem)] overflow-y-auto"
          >
            ...
            <div className="p-6">
              ...
              <p className="text-gray-500 text-center mb-6 text-sm">
                New to Respira? Create an account to start your breathing
                journey and unlock all features.
              </p>
